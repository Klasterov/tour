...
(function() {
  ...
  const sections = ['sec-route','sec-about','sec-info','sec-departure','sec-similar','sec-reviews'];
  ...
  window.addEventListener('scroll', function() {
    ...
    tabs.forEach(t => t.classList.toggle('active', t.getAttribute('data-target') === cur));
  }, { passive: true });
})();
